...
from ..models import Notice, NoticeImage, User_WorkDay
...
def notify_count_change(sender, instance, **kwargs):
    def send_ws_update():
        ...
        current_null_count = User_WorkDay.objects.filter(
        ...
        qs = (
            User_WorkDay.objects.filter(user_uuid_id=user_uuid, is_approved=False)
            .order_by("-work_date")
...
def delete_notice_image_file(sender, instance, **kwargs):
