import AdminPanel from "../components/AddButton";
import { useAdminInformationLogic } from "../hooks/useAdminInformationLogic";
...
const AdminInformation = ({ person, onClose, onSave }) => {
  ...
  if (showPanel) {
    return (
      <Modal isOpen onClose={handleBackFromPanel} isCentered>
        <ModalOverlay />
