export const EXTRA_WORK_TYPES = [
  { value: "weekday_ot", label: "평일 잔업", submitLabel: "평일 잔업", aliases: ["잔업"] },
  { value: "holiday_special", label: "휴일 특근", submitLabel: "휴일 특근", aliases: ["주간 특근", "야간 특근"] },
  { value: "holiday_ot", label: "휴일 잔업", submitLabel: "휴일 잔업", aliases: [] },
  { value: "night_ot", label: "야간 잔업", submitLabel: "야간 잔업", aliases: ["철야 잔업", "철야연장"] },
